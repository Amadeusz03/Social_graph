...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Edge_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Edge_t qt_meta_stringdata_Edge = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Edge[] = {
...
Q_CONSTINIT const QMetaObject Edge::staticMetaObject = { {
    ...
    qt_meta_stringdata_Edge.offsetsAndSizes,
    qt_meta_data_Edge,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Edge_t,
        // Q_OBJECT / Q_GADGET
