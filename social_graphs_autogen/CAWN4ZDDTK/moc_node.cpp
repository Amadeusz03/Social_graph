...
Q_CONSTINIT static const qt_meta_stringdata_Node_t qt_meta_stringdata_Node = {
    {
        ...
        QT_MOC_LITERAL(5, 12),  // "mousePressed"
        QT_MOC_LITERAL(18, 0),  // ""
        QT_MOC_LITERAL(19, 5),  // "Node*"
        QT_MOC_LITERAL(25, 4)   // "node"
    },
    "Node",
    "mousePressed",
    "",
...
void Node::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->mousePressed((*reinterpret_cast< std::add_pointer_t<Node*>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Node::mousePressed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Node::mousePressed(Node * _t1)
{
